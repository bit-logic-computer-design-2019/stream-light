...
HD_PWD='E:/vivado/light_stream2/light_stream2.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log light_stream1.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source light_stream1.tcl -notrace
