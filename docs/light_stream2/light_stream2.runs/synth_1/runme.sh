...
HD_PWD='E:/vivado/light_stream2/light_stream2.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log light_stream1.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source light_stream1.tcl
